...
enum HardwareType {HardwareDevice_t=0, VrepHandle_t=1, VrepMotor_t=2, DCMotor_Transistor_t=3, DCMotor_Hbridge_t=4, StepperMotor_t=5, 
  ServoMotor_t=6, VrepSensor_t=10, VisionSensor_t = 11, ProximitySensor_t = 12,
...
class HardwareDevice {       // The class
  ...
  protected:
  	std::string handle_name;  // Name of the joint/sensor in Vrep or jus an id 
